        ...
        CommandLineRunner initData(
                ...
                return args -> {
                        ...
                        Rol estudianteRole = rolRepository.findByNombre("ESTUDIANTE")
                                        .orElseGet(() -> rolRepository
                                                        .save(Rol.builder().nombre("ESTUDIANTE").build()));
                        ...
                        try {
                                ...
                                System.out.println("MongoDB no disponible, se omiten datos de rúbricas/actas: "
                                                + e.getMessage());
                        }
